...
public class TopTweet {
    ...
    public static void main(String[] args) throws Exception {
        ...
        props.setProperty(TwitterSource.CONSUMER_KEY, "gp09Jn6hy4ML8yu4ZLLsreoeq");
        props.setProperty(TwitterSource.CONSUMER_SECRET, "eiHSxYS5JXF15n8djuHTqsPoAqxjsoj8BcMMztSfYTdFD27yC3");
        props.setProperty(TwitterSource.TOKEN, "4342445294-NwYLVWLoiLv9C74Hky7oRFEYHuCkLbe9bVQrGpr");
        props.setProperty(TwitterSource.TOKEN_SECRET, "YZNcnqtf3U8BB6DmdPPOUp7HYN2UrIXHR1RBdwpVcfB9u");
